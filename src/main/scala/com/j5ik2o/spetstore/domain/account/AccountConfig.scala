...
import com.j5ik2o.spetstore.domain.item.{Category, CategoryRepository, CategoryId}
import scala.util.Try
import com.j5ik2o.spetstore.infrastructure.support.EntityIOContext

/**
 * [[com.j5ik2o.spetstore.domain.account.Account]]の設定を表す値オブジェクト。
 *
